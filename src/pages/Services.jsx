...
const Services = () => {
  ...
  return (
    <div>
      ...
      >
        <h1 className="z-10">Our Services</h1>
      </div>


      <div className="flex flex-col md:flex-row bg-white py-10 px-[10%]">
      ...
      <div className='px-[10%] py-10 bg-[#fd2d96]' style={{
        backgroundImage: `linear-gradient(rgba(34,193,195,1) , rgba(253,45,150,1))`
      }}>
        <h2 className='text-center pb-3 text-3xl font-bold text-primary '>Service Rates for the CarRent NCR </h2>
        <CarRatesTable />
      </div>
        ...
        {cars.map((car, index) => (
          ...
          <div className="bg-white shadow-lg rounded-lg p-4">
            ...
            <div className="relative group overflow-hidden rounded-lg">
              ...
              />
               {/* Overlay (Appears Only Over Image) */}
